        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="?act=customer_create" method="POST" enctype="multipart/form-data">
                            <!-- Họ và tên -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="dia_chi" name="dia_chi" class="form-control" placeholder="Hà Nội"
                                    required>
                            </div>
                            ...
                            <div class="row justify-content-end g-2">
                                <div class="col-lg-2">
                                    <a href="?act=list_accounts" class="btn btn-outline-secondary w-100">Hủy</a>
                                </div>
                                <div class="col-lg-2">
