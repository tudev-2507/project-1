        ...
        <div class="row g-2 mb-3">
            <div class="col-md-6">
                <form action="?act=product_attribute_create" method="POST" class="input-group">
                    ...
                    <input type="hidden" name="return_act" value="product_edit">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="so_luong" name="so_luong" class="form-control"
                                            value="<?= $product['so_luong'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control variation-color"
                                                    name="variations[<?= $index ?>][id_mau]" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control variation-size"
                                                    name="variations[<?= $index ?>][id_kich_co]" required>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePricePreview() {
        document.querySelectorAll('.price-input').forEach(function(input) {
            input.addEventListener('input', function() {
                document.getElementById('product-price-preview').textContent = numberFormat(this
                    .value || "0");
            });
        });
    }
    ...
    function checkPriceValidity() {
        ...
        document.querySelectorAll('.variation-item').forEach(function(variation, index) {
            ...
            let promoPriceInput = variation.querySelector('.promo-price');
            ...
            if (promoPrice < 0) {
                ...
                isValid = false;
                alert('Giá khuyến mãi của biến thể ' + (index + 1) + ' phải nhỏ hơn giá bán (' +
    ...
    function attachValidationEvents() {
        ...
        document.querySelectorAll('.price-input, .promo-price').forEach(function(input) {
